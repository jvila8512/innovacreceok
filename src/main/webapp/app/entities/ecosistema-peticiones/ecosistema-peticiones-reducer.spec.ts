...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ecosistema-peticiones.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECOSISTEMAPETICIONES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ECOSISTEMAPETICIONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ECOSISTEMAPETICIONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ECOSISTEMAPETICIONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ECOSISTEMAPETICIONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ECOSISTEMAPETICIONES actions', async () => {
      const expectedActions = [
        {
