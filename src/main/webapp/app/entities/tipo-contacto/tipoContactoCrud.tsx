...
import { getEntity, updateEntity, createEntity, reset, getEntities, deleteEntity } from './tipo-contacto.reducer';
...
const TipoContactoCRUD = (props: RouteComponentProps<{ id: string; index: string }>) => {
    ...
    <div className="grid">
      <div className="col">
        <div className="flex justify-content-start  font-bold  m-2">
          <div className="text-primary text-xl">Tipo de Contactos</div>
        </div>
      </div>
      <div className="col">
      ...
      <div className="col-12">
        <div className="card">
          ...
          <DataTable
            ...
            currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} Tipo Contacto"
            filters={filters as DataTableFilterMeta}
            filterDisplay="menu"
            loading={loading}
            emptyMessage="No hay Tipo de Contacto.."
            header={header}
            responsiveLayout="stack"
          >
            <Column field="id" header="Id" hidden></Column>
            <Column field="tipoContacto" header="Tipo Contacto" sortable headerStyle={{ minWidth: '50rem' }}></Column>
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {selectedTipoIdea && (
                <span>
                  ¿Seguro que quiere eliminar el Tipo de Contacto: <b>{selectedTipoIdea.tipoContacto}</b>?
                </span>
              )}
            </div>
          </Dialog>
...
export default TipoContactoCRUD;
