...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOCONTACTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOCONTACTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOCONTACTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOCONTACTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOCONTACTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOCONTACTO actions', async () => {
      const expectedActions = [
        {
