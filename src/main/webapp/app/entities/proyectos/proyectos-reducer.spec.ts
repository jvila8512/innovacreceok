...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './proyectos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROYECTOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROYECTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROYECTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROYECTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROYECTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROYECTOS actions', async () => {
      const expectedActions = [
        {
