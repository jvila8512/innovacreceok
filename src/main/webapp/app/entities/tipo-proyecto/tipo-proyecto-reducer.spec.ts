...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOPROYECTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOPROYECTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOPROYECTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOPROYECTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOPROYECTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOPROYECTO actions', async () => {
      const expectedActions = [
        {
