...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tramite.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAMITE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRAMITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRAMITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRAMITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRAMITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRAMITE actions', async () => {
      const expectedActions = [
        {
