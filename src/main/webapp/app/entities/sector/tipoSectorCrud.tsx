...
import { getEntity, updateEntity, createEntity, reset, getEntities, deleteEntity } from './sector.reducer';
...
const TipoSectorCRUD = (props: RouteComponentProps<{ id: string; index: string }>) => {
  ...
  const [filters, setFilters] = useState({
    ...
    sector: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
  });
  ...
  const rightToolbarTemplate = () => {
    return (
      <React.Fragment>
        <Button label="Nuevo Sector" icon="pi pi-plus" className="p-button-info" onClick={verDialogNuevo} />
      </React.Fragment>
    );
  };
    ...
    <div className="grid">
      <div className="col">
        <div className="flex justify-content-start  font-bold  m-2">
          <div className="text-primary text-xl">Sectores</div>
        </div>
      </div>
      <div className="col">
      ...
      <div className="col-12">
        <div className="card">
          ...
          <DataTable
            ...
            currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} Tipo Sector"
          ...
          >
            ...
            <Column field="sector" header="Sector" sortable headerStyle={{ minWidth: '50rem' }}></Column>

            <Column body={actionBodyTemplate} headerStyle={{ minWidth: '10rem' }}></Column>
          </DataTable>

          <Dialog visible={retoDialogNew} style={{ width: '450px' }} header="Sector" modal className="p-fluid  " onHide={hideDialogNuevo}>
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {selectedTipoIdea && (
                <span>
                  ¿Seguro que quiere eliminar el Sector: <b>{selectedTipoIdea.sector}</b>?
                </span>
              )}
            </div>
          </Dialog>
