...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORIAUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORIAUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORIAUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORIAUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORIAUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORIAUSER actions', async () => {
      const expectedActions = [
        {
