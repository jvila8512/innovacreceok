...
import { getEntity, updateEntity, createEntity, reset, getEntities, deleteEntity } from './categoria-user.reducer';
...
const CategoriaCRUD = (props: RouteComponentProps<{ id: string; index: string }>) => {
  ...
  const rightToolbarTemplate = () => {
    return (
      <React.Fragment>
        <Button label="Nueva Categoría" icon="pi pi-plus" className="p-button-info" onClick={verDialogNuevo} />
      </React.Fragment>
    );
  };
    ...
    <div className="grid">
      <div className="col">
        <div className="flex justify-content-start  font-bold  m-2">
          <div className="text-primary text-xl">Categorías de los Usuarios</div>
        </div>
      </div>
      <div className="col">
      ...
      <div className="col-12">
        <div className="card">
          ...
          >
            ...
            <Column field="categoriaUser" header="Categoría" sortable headerStyle={{ minWidth: '50rem' }}></Column>
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {selectedTipoIdea && (
                <span>
                  ¿Seguro que quiere eliminar la Categoría: <b>{selectedTipoIdea.categoriaUser}</b>?
                </span>
              )}
            </div>
          </Dialog>
