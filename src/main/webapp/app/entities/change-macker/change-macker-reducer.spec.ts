...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHANGEMACKER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHANGEMACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHANGEMACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHANGEMACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHANGEMACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHANGEMACKER actions', async () => {
      const expectedActions = [
        {
