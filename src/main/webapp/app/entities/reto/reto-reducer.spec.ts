...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RETO_LIST actions', async () => {
    ...
    it('dispatches FETCH_RETO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RETO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RETO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RETO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RETO actions', async () => {
      const expectedActions = [
        {
