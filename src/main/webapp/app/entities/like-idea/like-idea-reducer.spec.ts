...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './like-idea.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIKEIDEA_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIKEIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIKEIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIKEIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIKEIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIKEIDEA actions', async () => {
      const expectedActions = [
        {
