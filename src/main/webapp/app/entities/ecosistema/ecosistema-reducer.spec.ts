...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECOSISTEMA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ECOSISTEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ECOSISTEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ECOSISTEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ECOSISTEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ECOSISTEMA actions', async () => {
      const expectedActions = [
        {
