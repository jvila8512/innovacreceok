...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECOSISTEMAROL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ECOSISTEMAROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ECOSISTEMAROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ECOSISTEMAROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ECOSISTEMAROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ECOSISTEMAROL actions', async () => {
      const expectedActions = [
        {
