...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ecosistema-componente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECOSISTEMACOMPONENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ECOSISTEMACOMPONENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ECOSISTEMACOMPONENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ECOSISTEMACOMPONENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ECOSISTEMACOMPONENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ECOSISTEMACOMPONENTE actions', async () => {
      const expectedActions = [
        {
