...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INNOVACIONRACIONALIZACION_LIST actions', async () => {
    ...
    it('dispatches FETCH_INNOVACIONRACIONALIZACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INNOVACIONRACIONALIZACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INNOVACIONRACIONALIZACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INNOVACIONRACIONALIZACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INNOVACIONRACIONALIZACION actions', async () => {
      const expectedActions = [
        {
