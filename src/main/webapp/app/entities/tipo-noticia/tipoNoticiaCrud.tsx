...
import { getEntity, updateEntity, createEntity, reset, getEntities, deleteEntity } from './tipo-noticia.reducer';
...
const TipoNoticiaCRUD = (props: RouteComponentProps<{ id: string; index: string }>) => {
  ...
  const [filters, setFilters] = useState({
    ...
    tipoNoticia: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
  });
  ...
  const rightToolbarTemplate = () => {
    return (
      <React.Fragment>
        <Button label="Nuevo Tipo Noticia" icon="pi pi-plus" className="p-button-info" onClick={verDialogNuevo} />
      </React.Fragment>
    );
  };
    ...
    <div className="grid">
      <div className="col">
        <div className="flex justify-content-start  font-bold  m-2">
          <div className="text-primary text-xl">Tipo de Noticias</div>
        </div>
      </div>
      <div className="col">
      ...
      <div className="col-12">
        <div className="card">
          ...
          <DataTable
            ...
            currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} Tipo Noticias"
            filters={filters as DataTableFilterMeta}
            filterDisplay="menu"
            loading={loading}
            emptyMessage="No hay Tipo de Noticias..."
            header={header}
            responsiveLayout="stack"
          >
            <Column field="id" header="Id" hidden></Column>
            <Column field="tipoNoticia" header="Tipo Noticia" sortable headerStyle={{ minWidth: '50rem' }}></Column>
          ...
          >
            <div className="field">
              ...
              <InputText id="name" readOnly value={selectedTipoIdea?.tipoNoticia} autoFocus />
            </div>
          </Dialog>
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {selectedTipoIdea && (
                <span>
                  ¿Seguro que quiere eliminar el Tipo de Noticia: <b>{selectedTipoIdea.tipoNoticia}</b>?
                </span>
              )}
            </div>
          </Dialog>
...
export default TipoNoticiaCRUD;
