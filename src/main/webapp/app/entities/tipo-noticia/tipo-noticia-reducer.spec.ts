...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPONOTICIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPONOTICIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPONOTICIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPONOTICIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPONOTICIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPONOTICIA actions', async () => {
      const expectedActions = [
        {
