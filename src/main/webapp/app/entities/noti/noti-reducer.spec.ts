...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './noti.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTI_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTI actions', async () => {
      const expectedActions = [
        {
