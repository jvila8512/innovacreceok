...
const VistaprincipalIdeaRetoOK = (
  ...
  const atras = () => {
    props.history.push(
      '/entidad/idea/ideasbyretos/' + props.match.params.idreto + '/' + props.match.params.idecosistema + '/' + props.match.params.index
    );
  };
...
export default VistaprincipalIdeaRetoOK;
