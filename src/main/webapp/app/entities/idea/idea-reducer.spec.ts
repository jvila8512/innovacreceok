...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './idea.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IDEA_LIST actions', async () => {
    ...
    it('dispatches FETCH_IDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IDEA actions', async () => {
      const expectedActions = [
        {
