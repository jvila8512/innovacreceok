...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './entidad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTIDAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENTIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENTIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENTIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENTIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENTIDAD actions', async () => {
      const expectedActions = [
        {
