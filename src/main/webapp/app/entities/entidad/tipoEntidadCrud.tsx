...
import { getEntity, updateEntity, createEntity, reset, getEntities, deleteEntity } from './entidad.reducer';
...
const TipoEntidadCRUD = (props: RouteComponentProps<{ id: string; index: string }>) => {
  ...
  const [filters, setFilters] = useState({
    ...
    entidad: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
  });
  ...
  const rightToolbarTemplate = () => {
    return (
      <React.Fragment>
        <Button label="Nueva Entidad" icon="pi pi-plus" className="p-button-info" onClick={verDialogNuevo} />
      </React.Fragment>
    );
  };
    ...
    <div className="grid">
      <div className="col">
        <div className="flex justify-content-start  font-bold  m-2">
          <div className="text-primary text-xl">Entidades</div>
        </div>
      </div>
      <div className="col">
      ...
      <div className="col-12">
        <div className="card">
          ...
          <DataTable
            ...
            currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} Entidades"
          ...
          >
            ...
            <Column field="entidad" header="Entidad" sortable headerStyle={{ minWidth: '50rem' }}></Column>
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {selectedTipoIdea && (
                <span>
                  ¿Seguro que quiere eliminar el Tipo de Entidad: <b>{selectedTipoIdea.entidad}</b>?
                </span>
              )}
            </div>
          </Dialog>
...
export default TipoEntidadCRUD;
