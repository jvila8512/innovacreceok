...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICIPANTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARTICIPANTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTICIPANTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTICIPANTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTICIPANTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTICIPANTES actions', async () => {
      const expectedActions = [
        {
