...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './noticias.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTICIAS_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTICIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTICIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTICIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTICIAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTICIAS actions', async () => {
      const expectedActions = [
        {
