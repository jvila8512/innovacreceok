...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './contacto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTACTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTACTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTACTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTACTO actions', async () => {
      const expectedActions = [
        {
