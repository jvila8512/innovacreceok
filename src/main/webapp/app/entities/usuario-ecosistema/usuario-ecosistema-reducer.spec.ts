...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './usuario-ecosistema.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USUARIOECOSISTEMA_LIST actions', async () => {
    ...
    it('dispatches FETCH_USUARIOECOSISTEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USUARIOECOSISTEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USUARIOECOSISTEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USUARIOECOSISTEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USUARIOECOSISTEMA actions', async () => {
      const expectedActions = [
        {
