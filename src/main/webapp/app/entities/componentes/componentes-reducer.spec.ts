...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPONENTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPONENTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPONENTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPONENTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPONENTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPONENTES actions', async () => {
      const expectedActions = [
        {
