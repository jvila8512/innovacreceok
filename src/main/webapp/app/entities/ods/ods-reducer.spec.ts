...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ods.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ODS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ODS actions', async () => {
      const expectedActions = [
        {
