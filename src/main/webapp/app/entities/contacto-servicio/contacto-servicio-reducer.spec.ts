...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contacto-servicio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTOSERVICIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTACTOSERVICIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTACTOSERVICIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTACTOSERVICIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTOSERVICIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTACTOSERVICIO actions', async () => {
      const expectedActions = [
        {
