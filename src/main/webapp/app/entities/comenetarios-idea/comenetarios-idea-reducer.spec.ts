...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './comenetarios-idea.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMENETARIOSIDEA_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMENETARIOSIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMENETARIOSIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMENETARIOSIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMENETARIOSIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMENETARIOSIDEA actions', async () => {
      const expectedActions = [
        {
