...
import { getEntity, updateEntity, createEntity, reset, getEntities, deleteEntity } from './linea-investigacion.reducer';
...
const LineaCRUD = (props: RouteComponentProps<{ id: string; index: string }>) => {
  ...
  const [filters, setFilters] = useState({
    ...
    linea: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
  });
  ...
  const rightToolbarTemplate = () => {
    return (
      <React.Fragment>
        <Button label="Nueva Linea" icon="pi pi-plus" className="p-button-info" onClick={verDialogNuevo} />
      </React.Fragment>
    );
  };
    ...
    <div className="grid">
      <div className="col">
        <div className="flex justify-content-start  font-bold  m-2">
          <div className="text-primary text-xl">Lineas de Investigación</div>
        </div>
      </div>
      <div className="col">
      ...
      <div className="col-12">
        <div className="card">
          ...
          <DataTable
            ...
            currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} Linea de Investigación"
            filters={filters as DataTableFilterMeta}
            filterDisplay="menu"
            loading={loading}
            emptyMessage="No hay Linea de Investigación.."
            header={header}
            responsiveLayout="stack"
          >
            <Column field="id" header="Id" hidden></Column>
            <Column field="linea" header="Linea de Investigación" sortable headerStyle={{ minWidth: '50rem' }}></Column>
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {selectedTipoIdea && (
                <span>
                  ¿Seguro que quiere eliminar la Linea de Investigación: <b>{selectedTipoIdea.linea}</b>?
                </span>
              )}
            </div>
          </Dialog>
