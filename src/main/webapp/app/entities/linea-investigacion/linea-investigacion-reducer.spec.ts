...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './linea-investigacion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINEAINVESTIGACION_LIST actions', async () => {
    ...
    it('dispatches FETCH_LINEAINVESTIGACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LINEAINVESTIGACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LINEAINVESTIGACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LINEAINVESTIGACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LINEAINVESTIGACION actions', async () => {
      const expectedActions = [
        {
