...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tipo-idea.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOIDEA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOIDEA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOIDEA actions', async () => {
      const expectedActions = [
        {
