...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REDESSOCIALES_LIST actions', async () => {
    ...
    it('dispatches FETCH_REDESSOCIALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REDESSOCIALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REDESSOCIALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REDESSOCIALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REDESSOCIALES actions', async () => {
      const expectedActions = [
        {
