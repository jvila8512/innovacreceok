...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './anirista.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIRISTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIRISTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIRISTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIRISTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIRISTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIRISTA actions', async () => {
      const expectedActions = [
        {
