...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contacto-change-macker.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTOCHANGEMACKER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTACTOCHANGEMACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTACTOCHANGEMACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTACTOCHANGEMACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTOCHANGEMACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTACTOCHANGEMACKER actions', async () => {
      const expectedActions = [
        {
